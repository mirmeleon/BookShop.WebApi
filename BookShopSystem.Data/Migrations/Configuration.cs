namespace BookShopSystem.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopSystem.Data.BookShopContext>
    {
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\Dell\\Downloads\\Softuni\\Asp.Net\\hw-uslovia\\08-kum-uslovieto-BookShopSystem-Solution\\BookShopSystem\\resources/categories.txt"))
            {
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\Dell\\Downloads\\Softuni\\Asp.Net\\hw-uslovia\\08-kum-uslovieto-BookShopSystem-Solution\\BookShopSystem\\resources/books.txt"))
            {
                var line = reader.ReadLine();
                line = reader.ReadLine();
                while (line != null)
        ...
        {
            using (var reader = new StreamReader("C:\\Users\\Dell\\Downloads\\Softuni\\Asp.Net\\hw-uslovia\\08-kum-uslovieto-BookShopSystem-Solution\\BookShopSystem\\resources/authors.txt"))
            {
                var line = reader.ReadLine();
                line = reader.ReadLine();
                while (line != null)
